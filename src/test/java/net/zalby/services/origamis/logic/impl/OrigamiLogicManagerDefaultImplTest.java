 ...
 *
 */
public class OrigamiLogicManagerDefaultImplTest {

	private OrigamiServiceClient serviceClientToMock;
	
	private OrigamiLogicManager logicManagerToTest;
	...
	public void init() throws IOException {
		...
		logicManagerToTest = new OrigamiLogicManagerDefaultImpl(serviceClientToMock);
	}
